 ...
 */
// 1
var characterName: String = "prashuk"
var weaponClassification: String = "ajmera"

// 2
characterName += " ilu"

// 3
var currentMana: Double = 53.822

// 4
var manaPercentage = String(currentMana / 100)

// 5
var debugStats = "\(characterName), \(weaponClassification), \(currentMana), \(manaPercentage)"
...
// 8
//debugStats += ", \(questStatus)"
debugStats.append(", \(questStatus)")
