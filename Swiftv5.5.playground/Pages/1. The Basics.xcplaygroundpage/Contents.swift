...
// Likewise, type safety prevents you from accidentally passing an optional String to a piece of code that requires a non-optional String. Type safety helps you catch and fix errors as early as possible in the development process.
...
var x = 0.0, y = 0.0, z = 0.0        // multiple var declare in single line
...
var red, green, blue: Double          // multiple annotation in single line
...
let 你好 = "你好世界" // (contains any char)

print(welcomeMessage, 你好, separator: " * ", terminator: "**end") // prints Hello * 你好世界 * 3.14159**end
// print(_:separator:terminator:) function prints its output in Xcode’s “console” pane. The separator and terminator parameter have default values, so you can omit them when you call this function. By default, the function terminates the line it prints by adding a line break. To print a value without a line break after it, pass an empty string as the terminator—for example, print(someValue, terminator: "")
...
if let actualNumber = Int(responseCode) {
    print("The string \"\(responseCode)\" has an integer value of \(actualNumber)") // prints
} else {
    print("The string \"\(responseCode)\" could not be converted to an integer")
}

if let firstNumber = Int("4"), let secondNumber = Int("42"), firstNumber < secondNumber && secondNumber < 100 {
    print("\(firstNumber) < \(secondNumber) < 100") // prints
}
