...
// The name property is automatically given a default value of nil, or “no name value”, because it’s of an optional type that's why this class doesn't require any init (better way to create class like this) (! -> also works) or create empty init
...
// Unlike structures, class instances don’t receive a default member-wise initializer.
...
if tenEighty === alsoTenEighty { // three equal signs
    print("tenEighty and alsoTenEighty refer to the same VideoMode instance.") // prints
}
